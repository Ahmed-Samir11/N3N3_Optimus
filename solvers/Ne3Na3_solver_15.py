"""
Ne3Na3 Solver 15 - Nearest Neighbor Route Optimization
========================================================

Improvements over Solver 12:
1. MAINTAIN aggressive fulfillment strategy from Solver 12 (100% fulfillment first)
2. Use Nearest Neighbor algorithm to optimize delivery order (minimize travel distance)
3. Two-phase: Phase 1 = Fulfill all orders, Phase 2 = Optimize route sequences
"""
...
def adaptive_memetic_solver(env: Any, time_budget: float = 20.0) -> Dict:
    ...
    max_no_improvement = 25  # Reduced for faster convergence
